...
if(isset($_REQUEST["type"]) && ($_REQUEST["type"])!=''){
  ...
  if($type=='stats'){
    ...
    if($opration=='delete'){
      ...
      $sql_delete="DELETE FROM `contuct_us` WHERE id='$id'";
          ...
          <div class="card-body--">
            <div class="table-stats order-table ov-h">
              <table class="table ">
                ...
                <tbody>
                  <?php
                  $cat_sql="SELECT * FROM `contuct_us` WHERE 1";
              ...
              while($mydata=mysqli_fetch_assoc($run_cat_sql)){
                ...
                ?>
                  <tr>
                    ...
                    <td> <span class="product"><?php echo $comment ?></span></td>
